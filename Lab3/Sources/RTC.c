...
void (*RTC_Callback_Global)(void *); /*!< Private global pointer to RTC user callback function */

BOOL RTC_Init(void (*userFunction)(void *), void *userArguments)
{
  UserArguments_Global = userArguments; // userArguments made globally(private) accessible
  RTC_Callback_Global = userFunction; // userFunction made globally(private) accessible
...
{
  (*RTC_Callback_Global)(UserArguments_Global); // RTC ISR callback function
}
